package es.charles.nfccardreader.parser.apdu.impl;

import es.charles.nfccardreader.iso7816emv.ITag;
import es.charles.nfccardreader.iso7816emv.TagAndLength;
import es.charles.nfccardreader.model.AbstractData;
import es.charles.nfccardreader.parser.apdu.IFile;
import es.charles.nfccardreader.parser.apdu.annotation.AnnotationData;
import es.charles.nfccardreader.parser.apdu.annotation.AnnotationUtils;
...
import es.charles.nfccardreader.utils.BitUtils;
